...
struct HeapA
{
 ...
 4) write add/subtract/divide/multiply member functions for each type that take your 3 UDTs//   i.e.
...
int main()
 {
     ...
     std::cout << "DoubleType multiply result=" << *dt.multiply(2.f).value << std::endl;
     ...
     std::cout << "New value of it = it / 0 = " << *it.divide(0).value << std::endl<< std::endl;
